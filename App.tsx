...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Simulate initial app load / data pre-fetching
    ...
    switch (currentView) {
      ...
      case 'item-groups':
        return (
          <ComingSoonPage 
            title="Item Groups" 
            description="We are currently building a powerful new way to organize, bundle, and manage your inventory categories. This feature will be available in the next update."
  ...
  if (isInitialLoading) {
    return (
      <div className="fixed inset-0 bg-[#161616] flex flex-col items-center justify-center z-[var(--z-splash)] animate-fade-in-fast">
        {/* Logo Container with White Background */}
        <div className="bg-white p-6 rounded-2xl mb-8 shadow-2xl animate-modal-enter">
          <img 
  ...
  return (
    <div className="min-h-screen bg-[#161616] text-[#f4f4f4] flex animate-fade-in-fast">
      ...
      >
        ...
        <header className="h-[48px] bg-[#161616] border-b border-[#393939] flex items-center justify-between px-4 sticky top-0 z-[var(--z-header)] shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="relative hidden md:block group">
              ...
              />
              <Search className="w-4 h-4 text-[#c6c6c6] absolute left-2 top-1/2 -translate-y-1/2 transition-colors group-hover:text-[#f4f4f4]" />
            </div>
        ...
        <main className="flex-1 overflow-hidden flex flex-col relative bg-[#161616]">
           ...
           <footer className="h-[48px] px-6 border-t border-[#393939] bg-[#161616] flex items-center justify-between text-[12px] md:text-[13px] text-[#8d8d8d] shrink-0 z-20">
              ...
              >
                ...
                <span className="relative inline-block credit-underline-flashy">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="animate-shine-bright font-extrabold text-[15px] transition-all hover:scale-110 inline-block px-1"
                  >
                    GM
                  </a>
                  <span className="text-[#8d8d8d] mx-1 text-[14px] font-light">&</span>
                  <a 
                    href="https://github.com/AveragedevRK/" 
                    target="_blank" 
                    rel="noopener noreferrer"
