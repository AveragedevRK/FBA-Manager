  ...
  return (
    <div className="p-4 md:p-6 h-full overflow-y-auto animate-fade-in-fast no-scrollbar">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 animate-slide-up-fade" style={{ animationDelay: '0ms' }}>
        <div>
          <h1 className="text-[24px] font-bold text-[#f4f4f4]">Dashboard</h1>
          <p className="text-[14px] text-[#c6c6c6]">Overview of shipment volume and inventory status.</p>
        </div>
      ...
      <div className="bg-[#262626] border border-[#393939] p-6 flex flex-col h-[400px] opacity-0 animate-slide-up-fade relative" style={{ animationDelay: '300ms' }}>
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-[18px] font-bold text-[#f4f4f4]">Shipment Volume Over Time</h3>
                  ...
                  {tooltip && (
                     ...
                     >
                        ...
                        <div className="flex justify-between gap-4">
                           <span className="text-[#8d8d8d]">Products sent:</span>
                           <span className="text-[#f4f4f4] font-mono">{tooltip.products}</span>
                        </div>
                        <div className="flex justify-between gap-4">
                           <span className="text-[#8d8d8d]">Units sent:</span>
